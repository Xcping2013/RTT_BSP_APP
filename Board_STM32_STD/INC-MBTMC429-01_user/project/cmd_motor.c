...
uint8_t  CommmandLine_speed(char *Commands)
{
	if(strncmp(Commands+1,"# velocity ",11)==0 ) 
  {
			...
			if(0<len&&len<=4)			
      {
				...
				{
					if(MotorConfig[0].PulseDiv==5 && MotorConfig[0].RampDiv==8)
					{
								if (MotorConfig[ActualMotor].VMax==70)										MotorConfig[ActualMotor].AMax=200;	//0.05s-->210---0.5/S
								else if (MotorConfig[ActualMotor].VMax<50)								MotorConfig[ActualMotor].AMax=MotorConfig[ActualMotor].VMax;	
								else if (49<MotorConfig[ActualMotor].VMax && MotorConfig[ActualMotor].VMax<105)		MotorConfig[ActualMotor].AMax=MotorConfig[ActualMotor].VMax*2;	
								else if (104<MotorConfig[ActualMotor].VMax && MotorConfig[ActualMotor].VMax<210)	MotorConfig[ActualMotor].AMax=MotorConfig[ActualMotor].VMax*3;		
								else 															MotorConfig[ActualMotor].AMax=2000;	
								SetAMax(ActualMotor, MotorConfig[ActualMotor].AMax);
						
//						if 			(MotorConfig[ActualMotor].VMax<75)					MotorConfig[ActualMotor].AMax=20;	
//						else if (MotorConfig[ActualMotor].VMax<101)					MotorConfig[ActualMotor].AMax=35;	
//						else if (MotorConfig[ActualMotor].VMax<131)					MotorConfig[ActualMotor].AMax=60;
//						else if (MotorConfig[ActualMotor].VMax<171)					MotorConfig[ActualMotor].AMax=100;
//						else if (MotorConfig[ActualMotor].VMax<231)					MotorConfig[ActualMotor].AMax=180;
//						else if (MotorConfig[ActualMotor].VMax<311)					MotorConfig[ActualMotor].AMax=330;
//						else if (MotorConfig[ActualMotor].VMax<401)					MotorConfig[ActualMotor].AMax=550;
//						else if (MotorConfig[ActualMotor].VMax<551)					MotorConfig[ActualMotor].AMax=1000;
//						else if (MotorConfig[ActualMotor].VMax<751)					MotorConfig[ActualMotor].AMax=1800;
//						else if (MotorConfig[ActualMotor].VMax<810)					MotorConfig[ActualMotor].AMax=2047;
//						else if (MotorConfig[ActualMotor].VMax<2048)				MotorConfig[ActualMotor].AMax=2047;
...
//						}
					...
					if(MotorConfig[0].PulseDiv==5 && MotorConfig[0].RampDiv==6)
					{
						if (MotorConfig[ActualMotor].VMax<100)
						{		SetAMax(ActualMotor, 7);	MotorConfig[ActualMotor].AMax=7;}
						else if (MotorConfig[ActualMotor].VMax<140)
						{		SetAMax(ActualMotor, 15);MotorConfig[ActualMotor].AMax=15;}
						else if (MotorConfig[ActualMotor].VMax<280)
						{		SetAMax(ActualMotor, 30);MotorConfig[ActualMotor].AMax=30;}
						else if (MotorConfig[ActualMotor].VMax<420)
						{		SetAMax(ActualMotor, 120);MotorConfig[ActualMotor].AMax=120;}
						else if (MotorConfig[ActualMotor].VMax<560)
						{		SetAMax(ActualMotor, 200);MotorConfig[ActualMotor].AMax=200;}
						else if (MotorConfig[ActualMotor].VMax<700)
						{		SetAMax(ActualMotor, 400);MotorConfig[ActualMotor].AMax=400;}
						else if (MotorConfig[ActualMotor].VMax<840)
						{		SetAMax(ActualMotor, 700);MotorConfig[ActualMotor].AMax=700;}
						...
						{		SetAMax(ActualMotor, 1000);MotorConfig[ActualMotor].AMax=1000;}
						else if (MotorConfig[ActualMotor].VMax<=118)
						{		SetAMax(ActualMotor, 1300);MotorConfig[ActualMotor].AMax=1300;}
						else if (MotorConfig[ActualMotor].VMax<2047)
						{		SetAMax(ActualMotor, 1800);MotorConfig[ActualMotor].AMax=1800;
						}		
...
//				else if(ProID==LIDOPEN)
				else
				{
					...
					if(MotorConfig[0].PulseDiv==7 && MotorConfig[0].RampDiv==13)
					{
						if 			(MotorConfig[ActualMotor].VMax<75)					MotorConfig[ActualMotor].AMax=5;	
						else if (MotorConfig[ActualMotor].VMax<101)					MotorConfig[ActualMotor].AMax=45;	
						else if (MotorConfig[ActualMotor].VMax<131)					MotorConfig[ActualMotor].AMax=80;
						else if (MotorConfig[ActualMotor].VMax<171)					MotorConfig[ActualMotor].AMax=130;
						else if (MotorConfig[ActualMotor].VMax<231)					MotorConfig[ActualMotor].AMax=230;
						else if (MotorConfig[ActualMotor].VMax<311)					MotorConfig[ActualMotor].AMax=420;
						else if (MotorConfig[ActualMotor].VMax<401)					MotorConfig[ActualMotor].AMax=750;
						else if (MotorConfig[ActualMotor].VMax<551)					MotorConfig[ActualMotor].AMax=1250;
						else if (MotorConfig[ActualMotor].VMax<2048)				MotorConfig[ActualMotor].AMax=2047;					
						SetAMax(ActualMotor, MotorConfig[ActualMotor].AMax);
					}
					else
...
uint8_t  CommmandLine_home(char *Commands)
{
	if(strncmp(Commands+1,"# search home from left to right ",33)==0 ) 
  {
		...
		if(ActualMotor<N_O_MOTORS)
		{
			...
			if(0<len&&len<=4)			
      {
				Homing_speed[ActualMotor]=strtol(s, &p, 10);	
				if(ActualMotor==0)			Write429Int(IDX_VMAX|MOTOR0, 2047);		
				else if(ActualMotor==1)	Write429Int(IDX_VMAX|MOTOR1, 2047);		
				else 										Write429Int(IDX_VMAX|MOTOR2, 2047);					
				SetAmaxAuto(ActualMotor, Homing_speed[ActualMotor]);
				RotateLeft(ActualMotor,Homing_speed[ActualMotor]);
				UART_Printf("<%d# is homing>\n",ActualMotor);
				return 1;
			}
			UART_SendStr("<NA>\n");return 1;
    }
