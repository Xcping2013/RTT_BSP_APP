...
#define CODE_RUN_LED_TOGGLE()   	GPIOD->ODR ^= BIT7 
//RGB
#define LED_BED_ON() 							GPIOD->BSRR=BIT6;	GPIOD->BRR=BIT5|BIT4
...
#define	EEPROM_SET	'V'						
/************↑↑↑↑↑↑项目配置对定义↑↑↑↑↑↑***************/
#define	BUTTON_ONLINE					1			//与BUTTON_OFFLINE区别：复位按键增加气缸回位动作
#define	BUTTON_OFFLINE				2			//急停接在IN3
#define	LIDOPEN								3
//#define	IAC_LCR							4
#define	JABIL_LCR							5

#define	BUTTON_VER3						6			
#define	BUTTON_ROAD						7
