...
{
		pinMode(spi_config->cs_pin, PIN_MODE_OUTPUT);
		pinSet(spi_config->cs_pin);
	
		pinMode(spi_config->sck_pin, PIN_MODE_OUTPUT);
		pinMode(spi_config->mosi_pin, PIN_MODE_OUTPUT);
		pinMode(spi_config->miso_pin, PIN_MODE_INPUT_PULLUP);
